...
<title>Welcome to 2NK SACCO Ticketing System</title>
...
<body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item">2NK SACCO TICKET RESERVATION SYSTEM</a>
    </div><br>
...
<i class="icon help"></i> Forgotten password? contact <a href="#0"> admin</a> for your  <a href="#">password</a> to access.
</div>
