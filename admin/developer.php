...
<html>
  ...
  <body>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">About us</h1>
         </div>
        <div class="ui horizontal divider"> T.S. WEBSITES</div>
		<div class="row">
        <div class="ui segment">
  <img class="ui centered medium circular image" src="laptop.jpg"><br>
  <div class="ui horizontal divider">About us</div>
		<p>Hi! We hope you like the software, First developed by Mr. George, A.K.A. Swagfin Thrones. Contact us for any support</p>
		<div class="ui horizontal divider">T.S. WEBSITES Contacts</div>
		<p> Reach us via <br> Email: <a>bizcaleo@gmail.com</a> <br>Tel : <a>+254 721426058</a><br> Thanks</p>
		</div>		
        </div>
			</div>	
		</div>
