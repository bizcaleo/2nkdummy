...
<body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item">2NK TICKET RESERVATION SYSTEM</a>
    </div><br>
    ...
    <select required id="destination">
      ...
      <option>NAKURU to MOMBASA</option>
	   <option>MOMBASA to NAKURU</option>
        ...
        <option>NAIROBI to NAIVASHA</option>
    </select>
  </div>   
  </div>
<div class="field">  
 ...
 <div class="field">
    <select name="gender" required id="travelclass">
      ...
      <option>First Class Travel</option>
      <option>Business Class Travel</option>
...
<input placeholder="Number of Seats" type="number" id="seats" min="1" max="30"  value="1" required>
  </div> 
<div class="field"> 
...
<input type="text" readonly required id="traveldate" class="datepicker-here form-control" placeholder="ex. August 03, 1998">
 ...
 <div><label>Kindly confirm your details</label></div>
...
<div class="ui attached message">
  <div class="header">WELCOME. PLEASE ENTER YOUR DETAILS </div>
   <div class="header">Order Ref: <span style="color:red;font-size:15px"><?php echo $_SESSION['ORDERREF']?> <a href='index.php'> Cancel Order</a></span> </div>
 ...
 <div class="field">
    <select name="ID" required id="ID">
     ...
     <div class="field">
         ...
         <input placeholder="ID Number" type="text" id="ID" required>
     </div>
  </div>
...
<div class="ui attached message">
  <div class="header">Validate Payment Information</div>
    <div class="header">Order Ref: <span style="color:red;font-size:15px"><?php echo $_SESSION['ORDERREF']?> <a href='index.php'>Cancel Order</a></span> </div> 
  <p>Please Enter Payment Details to Proceed</p>
</div>
...
<label>Payment</label>  
    <select name="gender" required id="paymentmethod">
      ...
      <option value="KCB_BANK">KCB</option>
...
<div class="ui icon input">
  <input value="700" type="text" id="amount" readonly>
</div></div>
 <div style="text-align:center">
...
<b>Before proceeding, re-check the following details you provived</b><br>
